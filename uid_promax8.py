...
# This is the reference mapping from the pasted file
UID_FINAL_REFERENCE = {
...
"What do you primarily do within the Agriculture industry?": 548
    # Note: This is a subset - you would add all the remaining mappings from the pasted file
}

# Function to load the complete UID Final reference
def load_uid_final_reference():
    """Load the complete UID Final reference data from the pasted file"""
    # This would be the complete mapping from your pasted file
    # For brevity, I'm showing a subset above, but you would include all mappings
    return UID_FINAL_REFERENCE
...
def initialize_session_state():
    ...
    defaults = {
        ...
        "uid_final_reference": load_uid_final_reference()
    }
...
if st.session_state.page == "home":
    ...
    with col2:
        st.markdown("### 2️⃣ Question Bank")
        st.markdown("View enhanced question bank:")
        st.markdown("• Snowflake reference questions")
        st.markdown("• Authority counts")
        st.markdown("• **UID Final reference**")
    ...
    with col3:
        ...
        st.markdown("• Enhanced matching algorithm")
